            ...
            <div className="flex items-center rounded-md dark:border dark:border-brandDark-700">
              ...
              <button id="dropdown-button" className="relative group">
                <img src={downArrow} alt="arrow-down"
                  className="rounded-r-md bg-brandDark-800 px-2 py-2 h-full border-s-2 border-brandDark-700 hover:bg-brandBlue-500" />

                <div id="resume-colors"
                  className="absolute hidden group-hover:block group-focus:block right-0 top-[44px] bg-brandDark-800 text-brandDark-100 rounded-md p-1 shadow-md space-y-1 border border-brandDark-700">
                  <p id="blue-option"
                    onClick={handleBlOption}
                    className="hover:bg-brandBlue-500 rounded-md py-1 px-4 text-sm">Blue
                  </p>

                  <p id="bw-option"
                    title="Black & White"
                    onClick={handleBwOption}
                    className="hover:bg-brandBlue-500 rounded-md py-1 px-4 text-sm">B&W</p>
                </div>
